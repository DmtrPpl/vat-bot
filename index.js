...
// зведення місяця — лаконічні списки
const monthSummary = [
  `📊 *Місяць ${yyyymm}*`,
  `— *Оборот*`,
  `   • дохід:   \`${num(M.incGross)}\``,
  `   • витрати: \`${num(M.expGross)}\``,
  `   • … разом: *\`${num(M.profitGross)}\`*`,
  `— *ПДВ*`,
  `   • зібрано:   \`${num(M.incVAT)}\``,
  `   • сплачено:  \`${num(M.expVAT)}\``,
  `   • … до сплати: *\`${num(M.vatDue)}\`*`,
  `— *Чистий після ПДВ:* *\`${num(M.netAfterVAT)}\`*`,
].join("\n");

// зведення року — той самий стиль
const yearSummary = [
  `📊 *Рік ${yyyy}*`,
  `— *Оборот*`,
  `   • доходи:  \`${num(Y.incGross)}\``,
  `   • витрати: \`${num(Y.expGross)}\``,
  `   • … прибуток: *\`${num(Y.profitGross)}\`*`,
  `— *ПДВ*`,
  `   • зібрано:   \`${num(Y.incVAT)}\``,
  `   • сплачено:  \`${num(Y.expVAT)}\``,
  `   • … до сплати: *\`${num(Y.vatDue)}\`*`,
