...
`.trim();
    ...
    out.push("");
    out.push(
      `📊 *Місяць ${yyyymm}*: оборот ${M.incGross}−${M.expGross} = *${M.profitGross}*, ПДВ ${M.incVAT}−${M.expVAT} = *${M.vatDue}*, чистий: *${M.netAfterVAT}*`
    );
    out.push(
      `📊 *Рік ${yyyy}*: оборот ${Y.incGross}−${Y.expGross} = *${Y.profitGross}*, ПДВ ${Y.incVAT}−${Y.expVAT} = *${Y.vatDue}*, чистий: *${Y.netAfterVAT}*`
    );
